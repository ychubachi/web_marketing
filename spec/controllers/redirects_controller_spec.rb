...
describe RedirectsController do
  ...
  describe "GET index" do
    it "assigns all redirects as @redirects" do
      ...
      assigns(:redirects).should eq([redirect])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested redirect as @redirect" do
      ...
      assigns(:redirect).should eq(redirect)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new redirect as @redirect" do
      ...
      assigns(:redirect).should be_a_new(Redirect)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created redirect as @redirect" do
        post :create, {:redirect => valid_attributes}, valid_session
        assigns(:redirect).should be_a(Redirect)
        assigns(:redirect).should be_persisted
      end

      it "redirects to the created redirect" do
        post :create, {:redirect => valid_attributes}, valid_session
        response.should redirect_to(Redirect.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved redirect as @redirect" do
        ...
        Redirect.any_instance.stub(:save).and_return(false)
        post :create, {:redirect => {}}, valid_session
        assigns(:redirect).should be_a_new(Redirect)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested redirect" do
        ...
        Redirect.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => redirect.to_param, :redirect => {'these' => 'params'}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the redirect as @redirect" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Redirect.any_instance.stub(:save).and_return(false)
        put :update, {:id => redirect.to_param, :redirect => {}}, valid_session
        assigns(:redirect).should eq(redirect)
      end
